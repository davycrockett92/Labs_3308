...
app.get('/home/pick_color', function(req, res) {
	...
	var color_options = 'select name from favorite_colors;'; // Write a SQL query to retrieve the colors from the database
	var color_message = 'select color_msg from favorite_colors;';// Write a SQL query to retrieve the color message for the selected color
...
app.get('/player_info/', function(req, res) {
  var info = 'select id, name from football_players;';
  db.any(info)
  .then(function (rows) {
...
app.get('/player_info/', function(req, res) {
  ...
  var games = 'select count(*) from football_players where';
  db.task('get-everything', task => {
    return task.batch([
      task.any(info),
      task.any(player),
...
// forgot the lab was due by 3 pm instead of midnight today.  Sorry about the obvious rush on and incompleteness of the assignment!
